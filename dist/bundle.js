            ...
            (function () {
              ...
              Typo.prototype = {
                  ...
                  for (i = 0, _len = lines.length; i < _len; i++) {
                    ...
                    if (ruleType == "PFX" || ruleType == "SFX") {
                      ...
                      for (
                        ...
                        var continuationClasses = this.parseRuleCodes(
                          additionParts[1]
                        );
                ...
                _parseDIC: function (data) {
                  ...
                  for (var i = 1, _len = lines.length; i < _len; i++) {
                    ...
                    if (parts.length > 1) {
                      ...
                      for (
                        var j = 0, _jlen = ruleCodesArray.length;
                        j < _jlen;
                        j++
                      ) {
                ...
                checkExact: function (word) {
                  ...
                  if (typeof ruleCodes === "undefined") {
                    ...
                    if (
                      ...
                      for (
                        i = 0, _len = this.compoundRules.length;
                        i < _len;
                        i++
                      ) {
                ...
                suggest: function (word, limit) {
                  ...
                  for (
                    var i = 0, _len = this.replacementTable.length;
                    i < _len;
                    i++
                  ) {
                        ...
                        if (s[1]) {
                          ...
                          for (j = 0; j < alphabetLength; j++) {
                            ...
                            if (replacementLetter != s[1].substring(0, 1)) {
                              _edit =
                                s[0] + replacementLetter + s[1].substring(1);
